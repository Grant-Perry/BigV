...
///
/// The current version references the live model classes. When V3 arrives,
/// freeze this version by giving it nested snapshot models the way V1 does,
/// and point the live classes at V3.
